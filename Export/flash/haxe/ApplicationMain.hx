...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TLotDClassicHx", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TLotDClassicHx", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TLotDClassicHx";
		app.meta["name"] = "TLotDClassicHx";
		app.meta["packageName"] = "com.sample.tlotdclassichx";
